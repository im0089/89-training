...
public class GeminiInteractionsClient : IGeminiJsonClient
{
    ...
    public GeminiInteractionsClient(
        HttpClient http, IOptions<GeminiOptions> options, ILogger<GeminiInteractionsClient> logger)
    {
        _http = http;
    ...
    public async Task<string> GenerateJsonAsync(
        string input, string responseSchemaJson, CancellationToken cancellationToken = default)
    {
