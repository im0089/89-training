...
public class GeminiOrderQueryTranslator : IOrderQueryTranslator
{
    ...
    public async Task<OrderSearchQuery?> TranslateAsync(
        string naturalLanguageQuery, CancellationToken cancellationToken = default)
    {
